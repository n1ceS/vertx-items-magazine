...
public class UserServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "save": {
          service.save(json.getJsonObject("user") != null ? new com.example.starter.model.User((JsonObject)json.getJsonObject("user")) : null,
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "checkCredentials": {
          service.checkCredentials(json.getJsonObject("user") != null ? new com.example.starter.model.User((JsonObject)json.getJsonObject("user")) : null,
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
        case "checkIfUserAlreadyExists": {
          service.checkIfUserAlreadyExists((java.lang.String)json.getValue("username"),
                        HelperUtils.createHandler(msg, includeDebugInfo));
          break;
        }
